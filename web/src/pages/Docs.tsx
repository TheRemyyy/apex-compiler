                        ...
                        <section key={idx}>
                            {section.items ? (
                                            ...
                                            return (
                                                <li key={itemIdx}>
                                                    <button
                                                        ...
                                                        className={`w-full text-left px-3 py-1.5 rounded-md text-[14px] font-medium transition-all duration-200 outline-none focus:outline-none focus:ring-0 ${isActive
                                ...
                                <button
                                    ...
                                    className={`w-full text-left px-3 py-1.5 rounded-md text-[14px] font-bold uppercase tracking-wider mb-2 transition-colors outline-none focus:outline-none focus:ring-0 ${normalizedPath === section.path ? 'bg-[#18181b] text-white shadow-sm border border-[#27272a]' : 'text-gray-500 hover:text-gray-300 hover:bg-[#18181b]/50'
                                        }`}
                                >
                                    {section.title}
                                </button>
