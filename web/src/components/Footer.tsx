            ...
            <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-4 gap-8">
                ...
                <div>
                    ...
                    <ul className="space-y-3 text-sm">
                        ...
                        <li><Link to="/docs/stdlib/overview.md" className="hover:text-white transition-colors">Standard Library</Link></li>                        <li><Link to="/changelog" className="hover:text-white transition-colors">Changelog</Link></li>
